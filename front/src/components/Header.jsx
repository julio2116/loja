...
const Header = () => {
  ...
  const { favoritesQTD } = useFavorites();
          ...
          <div className="flex gap-[10px] lg:gap-[30px]">
            ...
            <div className="flex relative lg:mr-[5px]">
              ...
              <div className="relative">
                <img width="41px" src={cart} alt="" />
                {favoritesQTD > 0 && (
                  <span className="absolute top-0 right-0 bg-[black] text-[white] text-[10px] rounded-[20px] flex justify-center items-center w-[20px] h-[20px]">
                    {favoritesQTD}
                  </span>
                )}
              </div>
